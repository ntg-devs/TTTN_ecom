...
let initwebRoutes = (app) => {
    ...
    router.get("/api/choose-ship-address", middlewareControllers.verifyTokenUser, addressUserController.chooseAddressForShip)
    //=================API MESSAGE============================//
    ...
    router.put('/api/admin/kol/applications/:id/approve', middlewareControllers.verifyTokenAdmin, kolController.handleUpdateApplicationStatus)
    router.put('/api/admin/kol/applications/:id/reject', middlewareControllers.verifyTokenAdmin, kolController.handleUpdateApplicationStatus)
    router.post('/api/kol/update-bank-info', middlewareControllers.verifyTokenUser, kolController.handleUpdateUserBankInfo)
    router.post('/api/kol/get-bank-info', middlewareControllers.verifyTokenUser, kolController.handleGetKolInfoWithCommission)
    ...
    router.get('/api/admin/kol/tier/statistics', middlewareControllers.verifyTokenAdmin, kolTierController.getTierStatistics)
    router.get('/api/admin/kol/tier/eligible-upgrades', middlewareControllers.verifyTokenAdmin, kolTierController.getEligibleUpgrades)
    ...
    router.post('/api/affiliate/chart_admin', middlewareControllers.verifyTokenUser, affiliateController.getDataForChartsAdmin);
    ...
    router.get('/api/products', middlewareControllers.verifyTokenUser, productController.getProductsForKOL)
    router.get('/api/aff/:shortCode', affiliateLinkController.handleRedirectAffiliateLink);
    router.get('/api/kol/dashboard', middlewareControllers.verifyTokenUser, affiliateDashboardController.getKolDashboard);
    router.get('/api/kol/products', middlewareControllers.verifyTokenUser, affiliateDashboardController.getProductsForKol);
    router.get('/api/kol/performance-stats', middlewareControllers.verifyTokenUser, affiliateAnalyticsController.getKolPerformanceStats);
    router.get('/api/kol/earnings-report', middlewareControllers.verifyTokenUser, affiliateAnalyticsController.getKolEarningsReport);
    ...
    router.get('/api/affiliate/dashboard', middlewareControllers.verifyTokenUser, affiliateController.getDashboard);
    router.get('/api/affiliate/export-performance', middlewareControllers.verifyTokenUser, affiliateController.exportKolPerformanceData);
    router.get('/api/affiliate/orders/:orderId/attribution', middlewareControllers.verifyTokenUser, affiliateController.getOrderAttributionSummary);
    router.get('/api/affiliate/export-data', middlewareControllers.verifyTokenAdmin, dataExportController.exportAffiliateData);
