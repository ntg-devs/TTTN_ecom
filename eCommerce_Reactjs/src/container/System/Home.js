...
import { getDataForChartsAdmin } from "../../services/affiliateService";
import moment from "moment";
import { Link } from "react-router-dom";
import DatePicker from "react-datepicker";

import "react-datepicker/dist/react-datepicker.css";
import KOLCharts from "./KOLCharts/KOLCharts";
ChartJS.register(
  CategoryScale,
  LinearScale,
  PointElement,
...
const Home = () => {
  ...
  const [activeKOL, setactiveKOL] = useState(false);
  ...
  let loadDataForChartsAdmin = async () => {
          ...
          <div className="row">
            ...
            <div className="col-xl-3 col-md-6">
              <div className="card bg-warning text-white mb-4">
                <div className="card-body">
                  ĐÁNH GIÁ ({CountCard.countReview})
                </div>
                <div className="card-footer d-flex align-items-center justify-content-between">
            ...
            <div className="col-xl-3 col-md-6">
              <div className="card bg-success text-white mb-4">
                <div className="card-body">
                  SẢN PHẨM ({CountCard.countProduct})
                </div>
                <div className="card-footer d-flex align-items-center justify-content-between">
                  <Link
                    className="small text-white stretched-link"
            ...
            <div className="col-xl-3 col-md-6">
              <div className="card bg-danger text-white mb-4">
                <div className="card-body">
                  THÀNH VIÊN ({CountCard.countUser})
                </div>
                <div className="card-footer d-flex align-items-center justify-content-between">
                  <Link
                    className="small text-white stretched-link"
