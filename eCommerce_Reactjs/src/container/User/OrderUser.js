                  ...
                  <div className="box-list-order">
                    <div className="content-top">
                      <div className="content-left">
                        ...
                        <span className="label-name-shop">Cloth shop</span>
                      ...
                      item.orderDetail
                        .filter(
                          (detail, index, self) =>
                            ...
                            self.findIndex(
                              (d) =>
                                d.productDetail._id === detail.productDetail._id
                            )
                        )
                        .map((detail, index) => {
                          price +=
                            detail.quantity *
                            detail.productDetail.discountPrice;
                          return (
                            <div key={index} className="content-center">
                              <div className="box-item-order">
                                <img
                                  src={detail.productImage[0].image}
                                  alt=""
                                />
                                <div className="box-des">
                                  <span className="name">
                                  ...
                                  <span className="type">
                                    Phân loại hàng:{" "}
                                    {detail.productDetail.nameDetail} |{" "}
