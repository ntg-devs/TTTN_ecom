...
import { fetchKolStatus } from "../../action/kolAction";
...
const Header = (props) => {
    ...
    const { isKol, kolStatus, isLoading } = useSelector((state) => state.kol);
    ...
    useEffect(() => {
        ...
        if (userData) {
            ...
            // Fetch KOL status for logged in users using Redux
            dispatch(fetchKolStatus());
                ...
                <div className="container">
                    <nav className="navbar navbar-expand-lg navbar-light w-100">
                        ...
                        <NavLink to="/" className="navbar-brand logo_h">
                            <img className="logo_cloth" src="/resources/img/logo_cloth3-rm.png" alt="" />
                        </NavLink>
                        <button
