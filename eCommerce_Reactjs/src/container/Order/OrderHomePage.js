...
import { getAffiliateAttribution } from "../../utils/affiliateUtils";
    ...
    let handleSaveOrder = async () => {
        if (!dataTypeShip.id) {
            ...
            if (activeTypePayment == 0) {
                ...
                console.log("TEST0", affiliateAttribution)
            ...
            <div className="wrap-order">
                <div className="wrap-heading-order">
                    <NavLink to="/" className="navbar-brand logo_h">
                        <img style={{ width: "100px" }} src="/resources/img/logo_cloth3-rm.png" alt="" />
                    </NavLink>
