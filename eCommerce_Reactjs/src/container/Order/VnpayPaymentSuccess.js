...
function VnpayPaymentSuccess(props) {
  ...
  useEffect(() => {
    ...
    //   let affiliateAttribution = JSON.parse(
    //     localStorage.getItem("affiliate_attribution")
    //   );

    //   if (affiliateAttribution) {
    //     orderData.affiliateAttribution = affiliateAttribution;
    //   }
      ...
      <div className="wrap-order">
        <div className="wrap-heading-order">
          <NavLink to="/" className="navbar-brand logo_h">
            <img
              style={{ width: "80px" }}
              src="/resources/img/logo_cloth3-rm.png"
              alt=""
            />
          </NavLink>
